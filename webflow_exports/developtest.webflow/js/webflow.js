...
Webflow.require('ix').init([
  {"slug":"side-nav","name":"Side Nav","value":{"style":{},"triggers":[{"type":"click","selector":".jm-main","stepsA":[{"width":"80%","transition":"width 500ms ease 0ms"}],"stepsB":[{"width":"100%","transition":"width 500ms ease 0ms"}]},{"type":"click","selector":".jm-side","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"click","stepsA":[{"transition":"transform 500ms ease 0ms","x":"200px","y":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}}
]);
